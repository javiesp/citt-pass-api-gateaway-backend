...
export class UsersService {
  ...
  async findUsersByProject(proyectId: number): Promise<User[]> {
    return this.userModel.find({ proyect_id: proyectId }).exec();
  }
  ...
  async findOneUserByMail(email: string): Promise<User> {
